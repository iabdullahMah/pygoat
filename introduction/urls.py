...
urlpatterns = [
    ...
    path("broken_access_control/secret", views.a1_broken_access_lab3_secret, name="broken_access_controle_secret"),
    ...
    path("auth_failure/lab3", views.auth_failure_lab3, name="auth_failure_lab3"),
